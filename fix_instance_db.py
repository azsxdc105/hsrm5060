#!/usr/bin/env python3
"""
Fix Instance Database
Add claim_type_id column to the actual database
"""
...
def fix_instance_database():
    """Fix the instance database"""
    
    db_path = 'instance/claims.db'
    
    if not os.path.exists(db_path):
        print("❌ Instance database not found!")
        return False
    ...
    try:
        ...
        # Now use Flask app context to work with models
